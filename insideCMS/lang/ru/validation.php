...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Строки локализации для валидации
    |--------------------------------------------------------------------------
    |
    ...
    | версий, например правила размера. Не стесняйтесь настраивать каждое 
    ...
    */
    ...
    'doesnt_contain' => 'Поле :attribute не должно содержать ни одно из следующего: :values.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Пользовательские строки локализации для валидации
    |--------------------------------------------------------------------------
    |
    | Здесь вы можете указать пользовательские сообщения валидации для 
    | атрибутов, используя соглашение "attribute.rule" для именования 
    | строк. Это позволяет быстро указать конкретную пользовательскую 
    | строку языка для данного правила атрибута.
    |
    */
